...
#rm -rf openwrt-packages-backup/luci/applications/luci-app-passwall
#rm -rf openwrt-packages-backup/luci/applications/luci-app-unblockneteasemusic
#rm -rf openwrt-packages-backup/packages
